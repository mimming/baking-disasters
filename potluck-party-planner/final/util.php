<?php
$app_base_path = "http://bakingdisasters.com/potluck-planner-final";

// Create the tables if they do not exist
function init_db()
{
  $db = sqlite_open('/home/mimming/bakingdisasters.com/database/baking_disasters_app_final.sqlite');
...
function list_attempts($recipe_id)
{
  ...
  foreach ($attempt_stubs as $attempt_stub) {
    ...
    try {
      ...
      $attempt = Array();
      $attempt['author_name'] = $activity['actor']['displayName'];
